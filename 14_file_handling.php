...
if (file_exists($file)) {
    ...
    $contents = "Abdullah" . PHP_EOL . "Riyadh" . PHP_EOL . "Messi" . PHP_EOL . "Ronaldo" . PHP_EOL . "Neymar";
    // fwrite() writes the contents to the file and returns the number of bytes written on success, or FALSE on failure.

    // if insufficient permission in writing change the permission level for project directory
    // sudo chmod -R 777 /opt/lampp/htdocs/php
